...
<link rel="stylesheet" type="text/css" href=""${pageContext.request.contextPath }/assets/css/UI_Style.css"><script type="text/javascript" src="/JS/jquery-1.10.2.js"></script>
	...
	$(this).stop().animate({color:'#000'}, 500);
			...
			$(".mainDropdownMenu .divMiddle").on("mouseenter",function() {
				...
				if(index>-1) {
					...
					$(".mainmenu:eq(0)").attr("src","assets/images/MainPage_Menu__menu2on.png"); //단기프로그래밍 mainmenu on
					hideMenu(2);
					hideMenu(3);
					hideMenu(4);
					showMenu(0,2,index);
		...
		<div id="Header_Outer_Wrap" style="border-top:1px solid #e8e8e8; border-bottom:3px solid #1b499b; height:54px; width:100%;"> <!-- 1px solid #e8e8e8;  -->
			<div id="Header_Wrap1709">
				...
				<div id="mainTopMenuBar">
					...
					<img class="mainmenu" src="${pageContext.request.contextPath }/assets/images/MainPage_Menu__menu2off.png"/>
...
<nav id="SNB_Wrap_1709">
	...
	<a href="http://bitacademy.com/Support/Support_cacaoView.asp" target="_blank"><img src="${pageContext.request.contextPath }/assets/images/KakaoTalk4SNB_1704.png" style="width:100%; "/></a>
</nav>
				...
				<div id="Content">
					<div class="hGroup1709">
						<p>
							<img src="${pageContext.request.contextPath }/assets/images/icn_Home.png"/>
							<img src="${pageContext.request.contextPath }/assets/images/icn_ArrowTriangleRight.png"/>지원안내
						</p>
						<h4>온라인문의 (Q&amp;A)</h4>
					</div>
									...
									<tbody>
										...
										<tr>
											...
											<td class="l">
												...
												<a href="${pageContext.request.contextPath }/board/view?no=${vo.no}" class="gulim12_gray_L">${vo.title } </a>
          ...
          <a class='listfont_btn bg_green'>1</a>&nbsp;<a href='/Support/Support_online_list.asp?gotopage=2&field=&field_value=' class='listfont_btn'>2</a> <a href='/Support/Support_online_list.asp?gotopage=3&field=&field_value=' class='listfont_btn'>3</a> <a href='/Support/Support_online_list.asp?gotopage=4&field=&field_value=' class='listfont_btn'>4</a> <a href='/Support/Support_online_list.asp?gotopage=5&field=&field_value=' class='listfont_btn'>5</a> <a href='/Support/Support_online_list.asp?gotopage=6&field=&field_value=' class='listfont_btn'>6</a> <a href='/Support/Support_online_list.asp?gotopage=7&field=&field_value=' class='listfont_btn'>7</a> <a href='/Support/Support_online_list.asp?gotopage=8&field=&field_value=' class='listfont_btn'>8</a> <a href='/Support/Support_online_list.asp?gotopage=9&field=&field_value=' class='listfont_btn'>9</a> <a href='/Support/Support_online_list.asp?gotopage=10&field=&field_value=' class='listfont_btn'>10</a> 
            <a href="/Support/Support_online_list.asp?gotopage=2&field=&field_value=" class="listfont_btn">&gt;&gt;</a>
							...
							<div class="btn_wrap r mar_t10" style="margin-right:5%;">
									...
									<a href="${pageContext.request.contextPath }/board/writeform" class="btnGreenBorder big">글쓰기</a>
		...
		<div id="Footer_Outer_Wrap" style="min-width:960px;">
			<div style="width:960px; margin:0 auto; height:180px; overflow-y:hidden;">
				<div class="fl" style="background-color:#122139; height:180px; padding-top:30px; padding-left:15px; font-size:13px; ">
					<div>
						<a href="#"><img src="${pageContext.request.contextPath }/assets/images/btn_footer_LogoBitacademy.png"/></a>
